...
public final class TelInfo {
    ...
    protected Sim[] scitems;
    ArrayList<Sim> scitemsArr;
   ...
   @ensures TelInfo != null;
    ...
    public static TelInfo getInstance(Activity activity) {//Context context) {
        ...
        telInf.scitemsArr = new ArrayList<Sim>();

        telInf.scitemsArr.add(new Sim("SIM 1 state", telInf.sim1_STATE));
        telInf.scitemsArr.add(new Sim("Integrated circuit card identifier (ICCID)", telInf.sim1_ICCID));
        telInf.scitemsArr.add(new Sim("Unique device ID (IMEI or MEID/ESN for CDMA)", telInf.sim1_IMEI));
        telInf.scitemsArr.add(new Sim("International mobile subscriber identity (IMSI)", telInf.sim1_IMSI));
        telInf.scitemsArr.add(new Sim("Service provider name (SPN)", telInf.sim1_SPN));
        telInf.scitemsArr.add(new Sim("Mobile country code (MCC)", telInf.sim1_MCC));
        telInf.scitemsArr.add(new Sim("Mobile operator name", telInf.sim1_MNC));
        telInf.scitemsArr.add(new Sim("Mobile country code + mobile network code (MCC+MNC)", telInf.sim1_MCC_MNC));
        telInf.scitemsArr.add(new Sim("Mobile station international subscriber directory number (MSISDN)", telInf.sim1_MSISDN));
        telInf.scitemsArr.add(new Sim("Location Area Code (LAC)", telInf.sim1_LAC));
        telInf.scitemsArr.add(new Sim("Cell Tower ID (CID)", telInf.sim1_CellID));

        if (telInf.isSIM2Ready) {
            telInf.scitemsArr.add(new Sim(" ", " "));
            telInf.scitemsArr.add(new Sim("SIM 2 state", telInf.sim2_STATE));
            telInf.scitemsArr.add(new Sim("Integrated circuit card identifier (ICCID)", telInf.sim2_ICCID));
            telInf.scitemsArr.add(new Sim("Unique device ID (IMEI or MEID/ESN for CDMA)", telInf.sim2_IMEI));
            telInf.scitemsArr.add(new Sim("International mobile subscriber identity (IMSI)", telInf.sim2_IMSI));
            telInf.scitemsArr.add(new Sim("Service provider name (SPN)", telInf.sim2_SPN));
            telInf.scitemsArr.add(new Sim("Mobile country code (MCC)", telInf.sim2_MCC));
            telInf.scitemsArr.add(new Sim("Mobile operator name", telInf.sim2_MNC));
            telInf.scitemsArr.add(new Sim("Mobile country code + mobile network code (MCC+MNC)", telInf.sim2_MCC_MNC));
            telInf.scitemsArr.add(new Sim("Mobile station international subscriber directory number (MSISDN)", telInf.sim2_MSISDN));
            telInf.scitemsArr.add(new Sim("Location Area Code (LAC)", telInf.sim2_LAC));
            telInf.scitemsArr.add(new Sim("Cell Tower ID (CID)", telInf.sim2_CellID));


            //telInf.scitemsArr.add(new Sim("NC (Neighboring Cell ", telInf.sim1_NC.toString() ));
