...
import com.upgenicsint.phonecheck.activities.NewMicESTestActivity
...
class NewMicESTest(context: Context) : Test(context) {
    ...
    override val jsonKey: String
        get() = Test.autoESFilterKey
    override val activityRequestCode = NewMicESTestActivity.REQ
    ...
    override fun perform(context: Context, autoPerformMode: Boolean): Int {
        startIntent(context, NewMicESTestActivity::class.java)
