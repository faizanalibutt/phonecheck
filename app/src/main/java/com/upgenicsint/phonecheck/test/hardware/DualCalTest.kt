...
class DualCalTest(context: Context) : Test(context) {
    ...
    init {
        ...
        subTests.put(Test.callTest1Key, SubTest(Test.callTest1Key))
        subTests.put(Test.callTest2Key, SubTest(Test.callTest2Key))
    }
    ...
    private fun callPhone(context: Context) {
        startIntent(context, DualCallActivity::class.java, activityRequestCode)
    }
