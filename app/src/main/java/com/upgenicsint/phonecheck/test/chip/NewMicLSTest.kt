...
import com.upgenicsint.phonecheck.activities.NewMicLSTestActivity
import com.upgenicsint.phonecheck.test.SubTest
import com.upgenicsint.phonecheck.test.Test
import org.json.JSONException

class NewMicLSTest (context: Context) : Test(context) {
    ...
    override val hasSubTest: Boolean
        get() = true
    override val jsonKey = Test.autoLSFilterKey

    override val activityRequestCode = NewMicLSTestActivity.REQ
    ...
    override fun perform(context: Context, autoPerformMode: Boolean): Int {
        startIntent(context, NewMicLSTestActivity::class.java)
