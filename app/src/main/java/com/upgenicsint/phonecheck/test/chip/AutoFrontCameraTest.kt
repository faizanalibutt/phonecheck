...
class AutoFrontCameraTest(context: Context) : Test(context) {
    ...
    override val activityRequestCode: Int
        get() = AutoCameraTestActivity.REQ_FRONT
    ...
    override fun startIntent(context: Context, target: Class<out Activity>, req: Int): Intent {
        ...
        intent.putExtra(AutoCameraTestActivity.CAMERA_TYPE_KEY, CameraFace.FACE_FRONT.value)
        try {
