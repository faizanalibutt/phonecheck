...
package com.upgenicsint.phonecheck.barcode.Camera;
...
final class CameraConfigurationManager {
  ...
  void initFromCameraParameters(OpenCamera camera) {
    ...
    cameraResolution = findBestPreviewSizeValue1(parameters, screenResolution);
    Log.i(TAG, "Camera resolution: " + cameraResolution);
    bestPreviewSize = findBestPreviewSizeValue1(parameters, screenResolution);
