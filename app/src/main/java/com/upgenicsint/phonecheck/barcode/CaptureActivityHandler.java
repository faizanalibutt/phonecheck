...
public final class CaptureActivityHandler extends Handler {
    ...
    /*private CameraTestActivity activity2;*/
    ...
    /*public CaptureActivityHandler(CameraTestActivity activity2,
                                  Collection<BarcodeFormat> decodeFormats,
                                  Map<DecodeHintType, ?> baseHints,
                                  String characterSet) {
        this.activity2 = activity2;
        Camera1APIImpl2Fragment camera1APIImpl2Fragment = new Camera1APIImpl2Fragment();
        decodeThread = new DecodeThread(activity2, decodeFormats, baseHints, characterSet,
                new ViewfinderResultPointCallback(camera1APIImpl2Fragment.getViewfinderView()));
        decodeThread.start();
        state = State.SUCCESS;
    }*/
